	...
	<div id="content" class="content-padding">
		...
		<div class="section-20">
			<div class="main-container">
				...
				<div id="hvfpaks4-8" style="height: 400px; margin: 30px auto 0;"></div>
			</div>
			<hr class="transform-line transform-line-left">
		</div>
			...
			<div class="main-container">
				<div class="column-group steps-animated">
					<div class="top-row clearfix">
						...
						<div class="wrap-img">
							<img class="hide-mobile-img animated step-1" data-animateFunction="fadeIn" src="<?php echo CFS()->get('image3-1'); ?>" alt="Picture">
							<div class="ellipse-label-img-box animated step-6" data-animateFunction="fadeIn">
								<div class="ellipse-table-box">
									<div class="ellipse-cell-box">
										<?php echo CFS()->get('blockquote-3'); ?>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="bottom-row clearfix">
						<div class="wrap-img img-size-1 hide-img"><img class="animated step-2" data-animateFunction="fadeIn" src="<?php echo CFS()->get('image3-2'); ?>" alt="Picture"></div>
