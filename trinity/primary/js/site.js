...
/*! formstone v1.4.8 [analytics.js] 2018-06-21 | GPL-3.0 License | formstone.it */
...
/*! formstone v1.4.8 [checkbox.js] 2018-06-21 | GPL-3.0 License | formstone.it */
...
/*! formstone v1.4.8 [checkpoint.js] 2018-06-21 | GPL-3.0 License | formstone.it */
...
/*! formstone v1.4.8 [cookie.js] 2018-06-21 | GPL-3.0 License | formstone.it */
...
/*! formstone v1.4.8 [lightbox.js] 2018-06-21 | GPL-3.0 License | formstone.it */
...
/*! formstone v1.4.8 [navigation.js] 2018-06-21 | GPL-3.0 License | formstone.it */
...
/*! formstone v1.4.8 [pagination.js] 2018-06-21 | GPL-3.0 License | formstone.it */
...
/*! formstone v1.4.8 [sticky.js] 2018-06-21 | GPL-3.0 License | formstone.it */
...
/*! formstone v1.4.8 [viewer.js] 2018-06-21 | GPL-3.0 License | formstone.it */
...
Site.modules.Page = (function($, Site) {
		...
		$(".js-mobile-sidebar-handle")
			.on("click", function() {
				if ($(this).hasClass("fs-swap-active")) {
					onSidebarSwapDeactivate($(this));
				} else {
					onSidebarSwapActivate($(this));
				}
			});
		$(".js-main-nav-toggle")
	...
	function fixIEsvg() {
		...
		if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./)) {
			console.log(STATIC_ROOT + "/images/icons.svg");
	...
	function onDocumentClick(e) {
		if ($("body").hasClass("fs-mobile-lock")) {
			if (!$(e.target).closest(".js-mobile-sidebar, .js-mobile-sidebar-handle").length) {
				onSidebarSwapDeactivate($(".js-mobile-sidebar-handle"));
			}
		}
	...
	function onSidebarSwapActivate(item) {
		$(item).addClass("fs-swap-active");
		$(".mobile_sidebar").addClass("fs-swap-active");
	...
	function onSidebarSwapDeactivate(item) {
		$(item).removeClass("fs-swap-active");
		$(".mobile_sidebar").removeClass("fs-swap-active");
