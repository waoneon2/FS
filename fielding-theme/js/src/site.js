...
-------------------------------------------*/
	...
	var Site = (function($, window) {
		...
		var BaseController = function() {
			...
			this.minXS = parseInt("@mq_min_xs", 10);
			this.minSM = parseInt("@mq_min_sm", 10);
			this.minMD = parseInt("@mq_min_md", 10);
			this.minLG = parseInt("@mq_min_lg", 10);
			this.minXL = parseInt("@mq_min_xl", 10);
...
*/
		...
		function onRespond(e, state) {
			...
			Controller.maxWidth = state.maxWidth;
