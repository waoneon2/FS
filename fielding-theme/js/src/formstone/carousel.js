// Local version of Formstone carousel
// Adding additional HTML element for pagination styling
// `.fs-carousel-pagination-wrap`
...
;(function ($, Formstone, undefined) {
	...
	function construct(data) {
		...
		if (data.pagination) {
			paginationHtml += '<div class="fs-carousel-pagination-wrap"><div class="' + RawClasses.pagination + '">';
